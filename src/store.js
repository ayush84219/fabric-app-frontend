...
export const store = {
  ...
  getDyeingMaterials: async () => {
    return fetch(`${BASE_URL}/google-sheets/dyeing-materials`, {
      headers: getHeaders(),
    }).then(handleResponse).then(data => data.data || []);
  },

  downloadDyeingMaterialsFileUrl: () => {
    return `${BASE_URL}/google-sheets/dyeing-materials/file`;
  },
