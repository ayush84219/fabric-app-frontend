...
const FabricIssued = () => {
  ...
  const fetchSheetData = async () => {
    try {
      ...
      console.log('Fetching Job Order data from backend...');
      const jobResponse = await fetch(`${API_BASE_URL}/google-sheets/job-orders`);
      ...
      setData(jobResult);
      console.log('Job Order data loaded:', jobResult.length, 'records');

      console.log('Fetching Fabric Roll data from backend...');
      const rollResponse = await fetch(`${API_BASE_URL}/google-sheets/fabric-rolls`);
      ...
      setFabricRollData(rollResult);
      console.log('Fabric Roll Data loaded:', rollResult.length, 'records');
